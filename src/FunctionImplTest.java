...
public class FunctionImplTest {
    public static void main(String[] args) {
         ...
         */
        //方法引用
        FunctionInterfaceTest functionInterfaceTest2 = FunctionImplTest::getInstance;
        //方法引用
        FunctionInterfaceTest functionInterfaceTest3 = FunctionImplTest::getMessage;
